...
u32 PRC_GetPrototypeDBBufferSizeEx_Common(const PRCPrototypeList * prototypeList,
                                          u32 kindMask,
...
BOOL PRC_InitPrototypeDBEx_Common(PRCPrototypeDB_Common * protoDB,
                                  void * buffer,
                                  const PRCPrototypeList * prototypeList,
                                  u32 kindMask,
...
BOOL PRC_InitInputPatternEx_Common(PRCInputPattern_Common * pattern,
                                   void * buffer,
