...
PLATFORM_ATTRIBUTE_INLINE int WFS_GetServerConnectedBitmap (const WFSServerContext * context)
{
	return context->all_bitmap;
}

PLATFORM_ATTRIBUTE_INLINE int WFS_GetServerBusyBitmap (const WFSServerContext * context)
{
	return context->busy_bitmap;
}

PLATFORM_ATTRIBUTE_INLINE int WFS_GetServerSyncBitmap (const WFSServerContext * context)
{
