...
PLATFORM_ATTRIBUTE_INLINE BOOL WFS_IsClientReady (const WFSClientContext * context)
{
	return context->fat_ready ? TRUE : FALSE;
}

PLATFORM_ATTRIBUTE_INLINE const WFSTableFormat * WFS_GetTableFormat (const WFSClientContext * context)
{
